                  ...
                  <div className="flex flex-wrap gap-3">
                    {skills.map((skill, skillIndex) => (
                      <Badge
                        key={skill}
                        variant="secondary"
                        className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 text-white/90 border-white/20 hover:from-blue-600/30 hover:to-purple-600/30 hover:scale-110 transition-all duration-300 font-medium cursor-default"
